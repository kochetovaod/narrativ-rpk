...
Сгенерировано: 2026-03-02 15:47:38
...
database/migrations/2026_02_16_103920_create_faq_categories_table.php
database/migrations/2026_02_16_113450_create_faqs_table.php
...
database/migrations/2026_02_27_185435_create_materials_table.php
database/migrations/2026_02_27_185459_create_technologies_table.php
database/migrations/2026_03_01_183315_create_product_category_filters_table.php
database/migrations/2026_03_01_183354_create_product_category_filter_values_table.php
database/migrations/2026_03_01_183447_create_product_filter_value_product_table.php
```
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('faq_categories', function (Blueprint $table) {
            ...
            // Индексы
            $table->index('active', 'faq_categories_active_index');
            $table->index('sort', 'faq_categories_sort_index');
            $table->index('published_at', 'faq_categories_published_at_index');
            $table->index(['active', 'sort'], 'faq_categories_active_sort_index');
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('technologies', function (Blueprint $table) {
            ...
            // Индексы
            $table->index('active', 'technologies_active_index');
            $table->index('sort', 'technologies_sort_index');
            $table->index('published_at', 'technologies_published_at_index');
            $table->index(['active', 'sort'], 'technologies_active_sort_index');
